...
export const usePosts = () => {
  ...
  return [context.posts, context.setPosts];
};

// WriteFreeboardPost Component
const WriteFreeboardPost = ({ navigation }) => {
...
export default WriteFreeboardPost;
