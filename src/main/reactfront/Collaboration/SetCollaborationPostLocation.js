...
import { useLocation } from './CollaborationLocationContext'; // Context import
...
const SetCollaborationLocation = ({ route, navigation }) => {
  const { setSelectedLocation } = useLocation(); // Context에서 setSelectedLocation 가져오기
  ...
  const handleConfirm = () => {
    ...
    setSelectedLocation(location); // Context의 값 업데이트
...
export default SetCollaborationLocation;
